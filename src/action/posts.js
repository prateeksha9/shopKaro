import { SORT_POSTS, UPDATE_POSTS, ADD_PRODUCT, DELETE_PRODUCT, EDIT_PRODUCT } from './actionType';
...
export default function fetchPosts() {
  return (dispatch) => {
    fetch(`https://my-json-server.typicode.com/prateeksha9/server/products`)
      .then((response) => {
...
export function deleteProductId(id) {
  return (dispatch) => {
    fetch(`https://my-json-server.typicode.com/prateeksha9/server/products/${id}`, {
      method: 'DELETE',
    })
      .then((response) => response.json())
      .then((data) => {
